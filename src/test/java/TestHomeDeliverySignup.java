...
import test.java.pages.OpenURL;
import test.java.pages.enterZipCode;
...
public class TestHomeDeliverySignup {
	...
	public void beforeTest(String targetEnvironment) throws UnsupportedEncodingException, MalformedURLException {
		...
		case "Galaxy S5":
			...
			capabilities.setCapability("deviceName", "4A94D81D");
		...
		*/
		String user = "mkofman@firstgam.com";
		String password = "123456";
		String host = "rogers.perfectomobile.com";
	...
	public void openHomepage() {
		/* FOR THE LINEAR (wrong way) CODING!!!
		...
		*/
		...
		OpenURL openurl = new OpenURL(); // Instant creation
		
		openurl.OpenHomePage(driver); // Call to separated "PAGE" Class (1st TEST)
	}	
	...
	public void enterZipCode() {
		...
		*/
		...
		enterZipCode zipcode = new enterZipCode();
		
		zipcode.EnterZipCode(driver);
	}
